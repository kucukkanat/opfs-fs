---
"@kucukkanat/opfs-fs": minor
---

Isolate transaction handles, protect readers during storage collection, and preserve filesystem semantics for links, filenames, appends, and TAR round trips. Add committed revision subscriptions, contextual typed errors, diagnostic events, and readable text/byte aliases.
